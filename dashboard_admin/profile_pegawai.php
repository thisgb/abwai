        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Profile Pegawai</h1>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($users as $u) : ?>
                                <tr>
                                    ...
                                    <td><?= $u['password']; ?></td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="edit_profile.php?id=<?= $u['id']; ?>">Edit</a>
                                        <a class="btn btn-danger btn-sm" href='action_delete.php?id=<?= $u['id']; ?>' onclick="return confirm('Apakah Anda yakin ingin menghapus?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
